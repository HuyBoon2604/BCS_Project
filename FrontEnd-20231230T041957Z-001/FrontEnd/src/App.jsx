...
import AuNav from "./page/collectionuserpage/AuNav";
import Collection from "./page/collectionuserpage/Collection";
import Save from "./page/collectionuserpage/Save";
import Follows from "./page/collectionuserpage/Follows";
import Settings from "./page/collectionuserpage/Settings";
import Insight from "./page/collectionuserpage/Insight";
...
const App = () => {
  return (
    <Routes>
      ...
      <Route  element={<AuNav />}>
      <Route path="/navbar" element={<AuNav />} />
